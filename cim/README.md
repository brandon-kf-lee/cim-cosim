...
## Contents
- binaries
    - Binaries necessary to run neural network (Includes sample image inputs, networks (full and quantized), training datasets).
- examples
    - Example code files that use either the CPU or CIM device for neural network inference.
- harness
    - Helper library that help with benchmarking performance.
- include
